...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userText = findViewById(R.id.consult_date);
        emailText =  findViewById(R.id.consult_title);
        repeatEmailText =  findViewById(R.id.repeatemail);
        passwordText = findViewById(R.id.message);
        repeatPassText = findViewById(R.id.sender);
        registerBtn =  findViewById(R.id.consultButton);
